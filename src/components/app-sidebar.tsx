...
import { LogoIcon } from "./ui/icons/home"
      ...
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              className="data-[slot=sidebar-menu-button]:!p-1.5 w-full flex items-center justify-center rounded-lg text-slate-900 dark:text-slate-200"
            >
              <a href="#">
                {/* <IconInnerShadowTop className="!size-5" /> */}
                <LogoIcon />
                {/* <span className="text-base font-semibold">Brio Health</span> */}
              </a>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
